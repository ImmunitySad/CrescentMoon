...
class ForestPath:
    ...
    def inicio(self):
        ...
        if 'paper' in inventory:
            ...
            print("A lot of trees around you, some bushes and a little stream.")
            print("You hear the sound of the birds, it's amazing sound.")
            print("There is a paper on the ground.\n")
...
class House:
    ...
    def inicio(self):
        ...
        print("House")
        print("You are standing in a open field of a house. There is stairs")
        print("that lead you to the attic and there is a trapdoor here.\n")
